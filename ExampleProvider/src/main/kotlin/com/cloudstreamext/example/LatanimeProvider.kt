...
class LatanimeProvider : AnimeProvider() {
    ...
    override suspend fun getMainPage(page: Int, request: HomePageRequest): HomePageList? {
        ...
        return HomePageList("Latanime", listOf(HomePageListResponse("Anime Latino", items)))
    }
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        val poster = fixUrl(doc.ogImage() ?: doc.selectFirst(".poster img, .cover img")?.attr("src"))
        ...
        val eps = doc.select("ul.episodes li a, .episode-list a, .cap-list a, div.ep-item a").mapNotNull { a ->
