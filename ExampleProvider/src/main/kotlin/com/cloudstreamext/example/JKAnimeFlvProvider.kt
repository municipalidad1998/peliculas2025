...
/** JKAnimeFlv - jkanimeflv.com */
class JKAnimeFlvProvider : AnimeProvider() {
    override var mainUrl = "https://jkanimeflv.com"
    override var name = "JKAnimeFlv"
    ...
    override suspend fun getMainPage(page: Int, request: HomePageRequest): HomePageList? {
        ...
        return HomePageList("JKAnimeFlv", listOf(HomePageListResponse("Anime", items)))
    }
