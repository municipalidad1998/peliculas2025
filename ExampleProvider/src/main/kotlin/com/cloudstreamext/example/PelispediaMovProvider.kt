...
/** PelispediaMov - pelispedia.mov - Movies and Series */
class PelispediaMovProvider : MovieProvider() {
    ...
    override suspend fun getMainPage(page: Int, request: HomePageRequest): HomePageList? {
        ...
        val items = doc.select("article, .movie-card, .card, div[class*=item], div[class*=post]").mapNotNull { el ->
        ...
        return HomePageList("PelispediaMov", listOf(HomePageListResponse("Peliculas y Series", items)))
    }
