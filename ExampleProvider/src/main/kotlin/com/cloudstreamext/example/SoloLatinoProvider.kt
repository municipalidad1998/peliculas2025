...
/** SoloLatino - sololatino.net */
class SoloLatinoProvider : MovieProvider() {
    ...
    override suspend fun getMainPage(page: Int, request: HomePageRequest): HomePageList? {
        ...
        return HomePageList("SoloLatino", listOf(HomePageListResponse("Películas y Series Latino", items)))
    }
