...
class Latanime : BaseSiteProvider() {
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val results = doc.select("article.anime-card, div.anime-card, .poster, div[class*=anime]").mapNotNull { el ->
        ...
        return newHomePageResponse(listOf(HomePageList("Anime Latino", results, true)))
    }
